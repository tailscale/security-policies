...
Vendors’ security practices must be initially evaluated as part of their contract review, and while still in use, on an annual basis.
...
As part of vendor evaluation and contracting, vendors’ security practices must be reviewed to ensure they sufficiently protect Tailscale’s and its customers’ data.
...
1. Ask vendors for their SOC 2 type II or type I report for an overview of their current security practices. If a SOC 2 report does not exist or where insufficient information is provided, Tailscale will ask the vendor to complete the Vendor Security Assessment Questionnaire (VSAQ).
...
3. For each notable gap or where insufficient information is provided, Tailscale can: ask the vendor to make a change or provide additional information, implement a mitigating control, or accept the risk. These must be documented in the risk register.
...
Tailscale’s Security team is responsible for reviewing and updating third party vendors on an annual basis.
